...
class ImagesCrudTest < FlowTestCase
  ...
  test 'delete an image' do
    ...
    ugly_cat_url = 'https://cdn.acidcow.com/pics/20100607/ugly_cats_24.jpg'
    images = Image.create!([
    ...
    assert images_index_page.showing_image?(url: images[1].url, tags: images[1].tag_list)
    assert images_index_page.showing_image?(url: images[0].url, tags: images[0].tag_list)
    ...
    assert_equal 'Delete success', images_index_page.flash_message(:success)

    assert_equal 1, images_index_page.images.count
    assert_not images_index_page.showing_image?(url: images[1].url, tags: images[1].tag_list)
    assert images_index_page.showing_image?(url: images[0].url, tags: images[0].tag_list)
  end
  ...
  test 'view images associated with a tag' do
    ...
    cat_url = 'https://cdn.acidcow.com/pics/20100607/ugly_cats_24.jpg'
    images = Image.create!([
    ...
    assert_equal 2, images_index_page.images.count
    assert_not images_index_page.showing_image?(url: images[2].url, tags: images[2].tag_list)
